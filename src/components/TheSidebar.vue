        ...
        <ul class="nav-list" style="overflow: visible">
          <li v-for="(menuItem, index) in menuItems" :key="index" :id="'links_' + index">
            <router-link
              ...
              :to="menuItem.link"
              :class="{ lihover: menuItem.link == $route.name }"
            >
              <i
                class="bx"
                :class="[menuItem.icon, { lihover: menuItem.link === $route.name }]"
              ></i>
              <span
                class="links_name"
                :class="{ lihover: menuItem.link == $route.name }"
      ...
      <div v-if="isLoggedIn" class="profile">
        <div class="profile-details">
          ...
          <i
            ...
            style="font-size: 30px; line-height: 45px"
          />
          <div class="name_job">
            <div class="name">
              {{ profileName }}
        ...
        <i
          ...
          id="log_out"
          style="cursor: pointer"
          @click.stop="$store.commit('logout')"
        />
      </div>
    </div>
  </div>
...
export default {
  props: {
    ...
    profileName: {
      type: String,
      default: "Raunak Sadhwani",
    },
    profileRole: {
      type: String,
      default: "FullStack vue developer",
    },
    isExitButton: {
      type: Boolean,
      default: true,
