...
<table>
    <tbody>
        <tr>
            <td>Students (ID)</td>
           <td>Aditya Gawade, Rank sadhwani </td> 
        </tr>
        <tr>
            <td>Semester</td>
...
The project involves the development of an voting Management System, serving as a centralized platform for efficient handling of employee-related operations within an organization. This system facilitates the management of voting from employee of organisation information. 
